  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: hint,
              hintStyle: styles.textStyle14.copyWith(color: 
       Color.fromARGB(255, 13, 12, 12)
        ),
        filled: true,
        fillColor: background,
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 18),//هذه المسافة داخل الحقل حول النص.
       ...
       style: const TextStyle( //ستايل النص الذي يكتبه المستخدم:
        fontSize: 15,
